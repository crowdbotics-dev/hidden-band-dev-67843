"""
Django settings for hidden_band_dev_67843 project.
...
ROOT_URLCONF = 'hidden_band_dev_67843.urls'
...
WSGI_APPLICATION = 'hidden_band_dev_67843.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "hidden_band_dev_67843 API",
    "DESCRIPTION": "API documentation for hidden_band_dev_67843 App",
    "VERSION": "v1",
}
